					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Applicatie: Verplaatsingen",
									"targetURL": "#projecterp-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"projecterp-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projecterp",
									"url": sap.ui.require.toUrl("projecterp")
								}
							}
						}
					}
